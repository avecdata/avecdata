            ...
            if (k && f) {
                ...
                for (k = 0; k < q.length; k++) {
                    ...
                    if (l != h) {
                        ...
                        if (d = f.chartCursor) d.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat("YYYY"), f.showCategoryAxis || (d.categoryBalloonEnabled = !1);
...
(function() {
    ...
    e.DataSetSelector = e.Class({
        construct: function(a) {
            ...
            this.position = "left";
            this.selectText = "Selecione:";
            this.comboBoxSelectText = "Selecione...";
        ...
        write: function(a) {
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < f.length)
                if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), g = b.listCheckBoxSize, l) {
                    ...
                    h.style.maxHeight = b.listHeight * 2.9 + "px";
