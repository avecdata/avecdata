...
class tabSimpleInline(admin.StackedInline):
    model = tabSimple
    extra = 0
    fields = ["get_edit_link", "title", "subtitle", "footer", "html"]
...
class SimpleDashboardAdmin(admin.ModelAdmin):
    save_on_top = True
    fields = ["title", "created_date", "published_date", "subject", "subject_detail", "keywords", "group", "open"]
    inlines = [tabSimpleInline]
	
@admin.register(tabSimple)
class tabSimpleAdmin(admin.ModelAdmin):
    save_on_top = True
    fields = ["title", "subtitle", "footer", "html"]
...
class PaineisAdmin(admin.ModelAdmin):
    save_on_top = True
    fields = ["title", "created_date", "published_date", "subject", "subject_detail", "keywords", "group", "open", "external_files"]
